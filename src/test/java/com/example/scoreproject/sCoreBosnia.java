...
public class sCoreBosnia {
    ...
    public void NewContractClassic () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000355");
    ...
    public void NewContractComfort () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000356");
    ...
    public void NewContractUniqo () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000357");
...
*/
    ...
    public void NewContractKapital () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000358");
    ...
    public void NewContractComfortDual () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000359");
    ...
    public void SPNFTBosnia () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000360");
