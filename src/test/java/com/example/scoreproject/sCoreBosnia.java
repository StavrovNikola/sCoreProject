...
public class sCoreBosnia {
    ...
    public void NewContractClassic () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000608");
    ...
    public void NewContractComfort () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000609");
    ...
    public void NewContractUniqo () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000610");
...
*/
    ...
    public void NewContractKapital () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000611");
    ...
    public void NewContractComfortDual () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000612");
    ...
    public void SPNFTBosnia () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000930");
