...
public class sCoreBosnia {
    ...
    public void NewContractClassic () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000343");
    ...
    public void NewContractComfort () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000344");
    ...
    public void NewContractUniqo () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000345");
...
*/
    ...
    public void NewContractKapital () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000346");
    ...
    public void NewContractComfortDual () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000347");
    ...
    public void SPNFTBosnia () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000348");
