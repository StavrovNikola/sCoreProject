...
public class sCoreBosnia {
    ...
    public void NewContractClassic () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000301");
    ...
    public void NewContractComfort () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000302");
    ...
    public void NewContractUniqo () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000303");
...
*/
    ...
    public void NewContractKapital () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000304");
    ...
    public void NewContractComfortDual () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000305");
    ...
    public void SPNFTBosnia () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000306");
