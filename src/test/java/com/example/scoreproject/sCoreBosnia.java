...
public class sCoreBosnia {
    ...
    public void NewContractClassic () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000308");
    ...
    public void NewContractComfort () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000309");
    ...
    public void NewContractUniqo () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000310");
...
*/
    ...
    public void NewContractKapital () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000311");
    ...
    public void NewContractComfortDual () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000312");
    ...
    public void SPNFTBosnia () throws Exception{
        ...
        BrojPonude.click();
        BrojPonude.clear();
        BrojPonude.sendKeys("0001000307");
